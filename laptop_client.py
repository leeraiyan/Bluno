...
# For testing
data_types = {"imu":data.IMU, "receiver":data.Receiver, "trigger":data.Trigger}
demo_types = {"imu":data.IMU}
    ...
    def handleNotification(self, cHandle, data):
        ...
        # this is how we handle data from the gunBluno
            ...
            if data == b'\xff':
                ...
                #the gun belongs to the second player
                did = 2
                d = data_types["trigger"](did)
                q.put(str(d))
        ...
        # this is how we handle data from the vestBluno
            ...
            if data == b'\xff':
                ...
                #the vest belongs to the first player
                did = 1
                d = data_types["receiver"](did)
                q.put(str(d))
...
class LaptopClient():
    ...
    def __init__(self) -> None:
        self.cipher = AESCipher("skeyskeyskeyskey")
        # self.cipher = None
